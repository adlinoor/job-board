...
function cloudinaryUpload(file, resourceType = "image") {
    return new Promise((resolve, reject) => {
        const uploadStream = cloudinary_1.v2.uploader.upload_stream({ resource_type: resourceType }, (err, res) => {
            if (err || !res)
...
function cloudinaryRemove(publicIdOrUrl) {
